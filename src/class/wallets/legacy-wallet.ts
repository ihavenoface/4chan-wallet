...
// TODO: re-implement or fix this circular dependency
// node node_modules/madge/bin/cli.js --warning --circular --extensions ts ./
...
export class LegacyWallet extends AbstractWallet {
  ...
  async broadcastTx(txhex) {
    ...
    // if (broadcast.state === "pending") return true; // todo check if this is right
    return broadcast.transactionHash && broadcast.transactionHash.length === 64; // this means return string is txid (precise length), so it was broadcasted ok
  }
